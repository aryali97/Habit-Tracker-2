...
- Use `screenshot` to capture simulator screenshots for verification. *Only do this if necessary since this is resource intensive.*
- Verification must include relevant UI automation via XcodeBuildMCP (tap, scroll, type, etc.), not just build.
